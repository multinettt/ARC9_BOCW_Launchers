ENT.Type = "anim"
ENT.Base = "base_anim"
ENT.PrintName = "RPG-7 Rocket (BOCW)"
ENT.Author = ""
ENT.Information = ""
ENT.Spawnable = false
...
if CLIENT then
    killicon.Add("arc9_bocw_rpg7_projectile", "entities/obit_arc9_bocw_rpg7.png", Color(255, 255, 255, 255))
end
...
if SERVER then
    ...
    function ENT:Initialize()
        self:SetModel("models/weapons/arc9/entities/bocw_rpg7_projectile.mdl")
